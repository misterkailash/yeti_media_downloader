...
<template>
  <div class="posts-section" :class="{ visible }">
    ...
    <div class="posts-grid">
      ...
      <div v-else-if="isPrivate" class="posts-empty">
        <svg viewBox="0 0 24 24" width="40" height="40" fill="none" stroke="#aaa" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="margin-bottom:12px">
          <rect x="3" y="11" width="18" height="11" rx="2" ry="2"/>
          <path d="M7 11V7a5 5 0 0110 0v4"/>
        </svg>
        <br><strong>This Account is Private</strong>
        <br><span style="font-size:.8rem;color:#999;margin-top:4px;display:inline-block">Log in with an account that follows this user to see their posts.</span>
        <br><button class="private-login-btn" @click="login.open()">
